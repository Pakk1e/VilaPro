...
export default function ElectricalWorkspaceShell({ children, library, inspector, instrument, headerCenter }) {
  ...
  return <div data-testid="electrical-workspace" data-focus-mode={focusMode ? "true" : "false"} className="flex h-full min-h-0 flex-col overflow-hidden bg-[#e7ebee] text-[#17253a]">
    ...
    <div className="relative min-h-0 flex-1 overflow-hidden">
      ...
      {!focusMode && inspectorOpen && <aside data-testid="workspace-inspector-surface" className="absolute bottom-4 right-4 top-4 z-30 flex w-[min(330px,calc(100vw-32px))] flex-col overflow-hidden rounded-2xl border border-[#cbd4dc] bg-[#fbfcfd]/98 shadow-[0_20px_50px_rgba(24,37,58,0.18)] backdrop-blur">{inspector}</aside>}
