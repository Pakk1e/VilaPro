...
export default function WorldNode({ id, data, selected }) {
  ...
  const handleNodeClick = event => { event.stopPropagation(); window.dispatchEvent(new CustomEvent("worlds:node-select", { detail: { nodeId: id } })); };
  ...
  return <div className="relative h-[116px] w-[180px] overflow-visible" onClick={handleNodeClick}>
