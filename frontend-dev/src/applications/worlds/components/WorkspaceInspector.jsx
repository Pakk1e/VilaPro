...
function ClearSelectionButton({ onClick }) {
  return <button type="button" onClick={onClick} className="rounded-md px-2 py-1.5 text-[8px] font-semibold text-[#7d8997] hover:bg-[#f1f4f6] hover:text-[#405067]">Clear selection</button>;
}
