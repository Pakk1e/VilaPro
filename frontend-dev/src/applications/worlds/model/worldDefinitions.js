export const worldDefinitions = {
  ...
  diode: {
    type: "Diode",
    description: "Semiconductor diode with forward conduction and reverse blocking",
    category: "Electrical",
    ports: [
      { id: "p", kind: "electrical", position: "left", label: "p" },
      { id: "n", kind: "electrical", position: "right", label: "n" },
    ...
    properties: {
      forwardVoltage: { type: "number", label: "Forward voltage", unit: "V", defaultValue: 0.7, min: 0 },
      onResistance: { type: "number", label: "On resistance", unit: "Ω", defaultValue: 1, min: 0 },
    },
    simulationParameters: [
      { property: "forwardVoltage", parameter: "Vf", label: "Forward voltage", unit: "V" },
      { property: "onResistance", parameter: "Ron", label: "On resistance", unit: "Ω" },
    ],
  },
  ...
  voltageSource: {
    ...
    properties: {
      waveform: { type: "select", label: "Waveform", options: [{ value: "dc", label: "DC" }, { value: "sine", label: "Sine" }, { value: "square", label: "Square" }], defaultValue: "dc" },
      voltage: { type: "number", label: "Voltage", unit: "V", defaultValue: 12, visibleWhen: { property: "waveform", equals: "dc" } },
      amplitude: { type: "number", label: "Amplitude", unit: "V", defaultValue: 12, min: 0, visibleWhen: { property: "waveform", notEquals: "dc" }, showOnNode: false },
      offset: { type: "number", label: "Offset", unit: "V", defaultValue: 0, visibleWhen: { property: "waveform", notEquals: "dc" }, showOnNode: false },
      frequency: { type: "number", label: "Frequency", unit: "Hz", defaultValue: 1, min: 0, visibleWhen: { property: "waveform", notEquals: "dc" }, showOnNode: false },
      phase: { type: "number", label: "Phase", unit: "°", defaultValue: 0, visibleWhen: { property: "waveform", notEquals: "dc" }, showOnNode: false },
      delay: { type: "number", label: "Delay", unit: "s", defaultValue: 0, min: 0, visibleWhen: { property: "waveform", notEquals: "dc" }, showOnNode: false },
    },
  ...
  currentSource: {
    ...
    properties: {
      waveform: { type: "select", label: "Waveform", options: [{ value: "dc", label: "DC" }, { value: "sine", label: "Sine" }, { value: "square", label: "Square" }], defaultValue: "dc" },
      current: { type: "number", label: "Current", unit: "A", defaultValue: 0.1, visibleWhen: { property: "waveform", equals: "dc" } },
      amplitude: { type: "number", label: "Amplitude", unit: "A", defaultValue: 0.1, min: 0, visibleWhen: { property: "waveform", notEquals: "dc" }, showOnNode: false },
      offset: { type: "number", label: "Offset", unit: "A", defaultValue: 0, visibleWhen: { property: "waveform", notEquals: "dc" }, showOnNode: false },
      frequency: { type: "number", label: "Frequency", unit: "Hz", defaultValue: 1, min: 0, visibleWhen: { property: "waveform", notEquals: "dc" }, showOnNode: false },
      phase: { type: "number", label: "Phase", unit: "°", defaultValue: 0, visibleWhen: { property: "waveform", notEquals: "dc" }, showOnNode: false },
      delay: { type: "number", label: "Delay", unit: "s", defaultValue: 0, min: 0, visibleWhen: { property: "waveform", notEquals: "dc" }, showOnNode: false },
    },
